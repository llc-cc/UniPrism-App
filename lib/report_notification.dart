...
class ReportResultPage extends StatelessWidget {
  const ReportResultPage({super.key, required this.reportId});
        ...
        child: ListView(
          ...
          children: [
            Container(
              ...
              child: const Column(
                ...
                children: [
                  Text(
                    '报告已生成',
                    style: TextStyle(color: Color(0xFFE8DFFF), fontSize: 13),
                  ),
                  SizedBox(height: 8),
                  Text(
                    '探索型创造者',
            ...
            const _ReportSection(
              title: '下一步建议',
              child: Text(
                '结合课程体验、院校信息和真实项目继续验证这些方向。正式接入后，这里会展示服务器生成的完整报告内容。',
                style: TextStyle(
                  fontSize: 14,
                  height: 1.7,
