        ...
        authChannel.setMethodCallHandler { call, result ->
            ...
            when (call.method) {
                ...
                "write" -> {
                    ...
                    listOf("uniprism.token", "uniprism.user", "uniprism.anonymousId", "uniprism.anonymousCookie", "uniprism.exploreSessionId", "uniprism.messages", "uniprism.privacyAcceptedVersion").forEach { key ->
